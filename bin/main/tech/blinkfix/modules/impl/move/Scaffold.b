...
public class Scaffold extends Module {
    ...
    private boolean isTellyBridging = false;
    ...
    public FloatValue firstYawSpeed = ValueBuilder.create(this, "First Yaw Speed")
            .setDefaultFloatValue(105.0F)
    ...
    public FloatValue lastYawSpeed = ValueBuilder.create(this, "Last Yaw Speed")
            .setDefaultFloatValue(155.0F)
            .setMaxFloatValue(180.0F)
            .setMinFloatValue(0.0F)
            .setFloatStep(5.0F)
            .setVisibility(() -> this.mode.isCurrentMode("Telly Bridge"))
...
//    public FloatValue straightTicks = ValueBuilder.create(this, "Straight Ticks")
//            .setDefaultFloatValue(2.0F)
//            .setMaxFloatValue(5.0F)
//            .setMinFloatValue(0.0F)
//            .setFloatStep(1.0F)
//            .setVisibility(() -> this.mode.isCurrentMode("Heypixel Telly"))
//            .build()
//            .getFloatValue();
//
//    public FloatValue jumpTicks = ValueBuilder.create(this, "Jump Ticks")
...
//            .getFloatValue();
//
//    public BooleanValue aimOnTower = ValueBuilder.create(this, "Aim On Tower")
//            .setDefaultBooleanValue(true)
//            .setVisibility(() -> this.mode.isCurrentMode("Heypixel Telly"))
//            .build()
//            .getBooleanValue();

    public FloatValue getoffGroundTicks = ValueBuilder.create(this, "Telly Ticks")
            .setDefaultFloatValue(4.0f)
            .setMaxFloatValue(5.0f)
            .setMinFloatValue(0.5F)
            .setFloatStep(0.5F)
            .setVisibility(() -> this.mode.isCurrentMode("Telly Bridge")
//                    || this.mode.isCurrentMode("Heypixel Telly")
            )
            .build()
            .getFloatValue();

//    FloatValue randomyawspeed1 = ValueBuilder.create(this, "Min Random Yaw Speed")
//            .setDefaultFloatValue(115.0F)
//            .setMaxFloatValue(180.0F)
//            .setMinFloatValue(1.0F)
//            .setFloatStep(5.0F)
//            .setVisibility(() -> this.mode.isCurrentMode("Heypixel Telly"))
...
//            .getFloatValue();
//
//    FloatValue randomyawspeed2 = ValueBuilder.create(this, "Max Random Yaw Speed")
//            .setDefaultFloatValue(165.0F)
//            .setMaxFloatValue(180.0F)
//            .setMinFloatValue(1.0F)
//            .setFloatStep(5.0F)
//            .setVisibility(() -> this.mode.isCurrentMode("Heypixel Telly"))
...
//            .getFloatValue();
    ...
    private boolean adStrafeLeft = false;
    private int adStrafeTicks = 0;
...
//        return (float) MathUtils.getRandomIntInRange((int) randomyawspeed1.getCurrentValue(), (int) randomyawspeed2.getCurrentValue());
//    }
    ...
    public void onEnable() {
        if (mc.player != null) {
            ...
            this.pos = null;
            this.baseY = 10000;
            this.currentYawSpeed = this.firstYawSpeed.getCurrentValue();
            this.isAccelerating = false;
            this.adStrafeTicks = 0;
            this.adStrafeLeft = false;
        }
    }
    ...
    public void onEventEarlyTick(EventRunTicks e) {
        if (e.getType() == EventType.PRE && mc.screen == null && mc.player != null) {
            ...
            if (mc.player.onGround()) {
                ...
                if (this.mode.isCurrentMode("Heypixel Telly")) {
                    this.ticksUntilJump++;
                }
            } else {
                this.offGroundTicks++;
            ...
            if ((this.mode.isCurrentMode("Telly Bridge") || this.mode.isCurrentMode("Heypixel Telly")) && isHoldingJump) {
                this.baseY = Math.max(this.baseY, (int)Math.floor(mc.player.getY()) - 1);
            }
            ...
            if (this.pos != null) {
                ...
                if (this.mode.isCurrentMode("Normal") && this.snap.getCurrentValue()) {
                    ...
                    this.rots.setX(RotationUtils.rotateToYaw(180, this.rots.getX(), this.correctRotation.getX()));
                }
            ...
            if (this.mode.isCurrentMode("Telly Bridge")) {
                if (PlayerUtils.movementInput()) {
                    if (mc.player.onGround()) {
                        if (this.pos != null && this.offGroundTicks == 0) {
                ...
                if (this.offGroundTicks < 1 && PlayerUtils.movementInput()) {
                    this.rots.setX(RotationUtils.rotateToYaw(currentYawSpeed, this.rots.getX(), mc.player.getYRot()));
                    this.lastRots.set(this.rots.getX(), this.rots.getY());
                    this.accelerateYawSpeed();
                    return;
                }
//            } else if (this.mode.isCurrentMode("Heypixel Telly")) {
//                this.isTellyBridging = this.ticksUntilJump >= (int)this.jumpTicks.getCurrentValue() && PlayerUtils.movementInput();
//                if (mc.player.onGround() && PlayerUtils.movementInput() && slotID != -1) {
//                    boolean doNotAim = this.offGroundTicks <= (int)this.straightTicks.getCurrentValue() &&
//                            this.ticksUntilJump >= (int)this.jumpTicks.getCurrentValue() &&
//                            !(isHoldingJump && this.aimOnTower.getCurrentValue());
//
//                    if (doNotAim && this.isTellyBridging) {
//                        mc.options.keyJump.setDown(true);
...
//
//                if (this.offGroundTicks < 1 && PlayerUtils.movementInput()) {
//                    this.rots.setX(RotationUtils.rotateToYaw(RotationSpeedRandom(), this.rots.getX(), mc.player.getYRot()));
//                    this.lastRots.set(this.rots.getX(), this.rots.getY());
//                    this.accelerateYawSpeed();
//                    return;
//                }
    ...
    private void accelerateYawSpeed() {
        if (this.isAccelerating) {
            this.currentYawSpeed += 5.0F;
            if (this.currentYawSpeed >= this.lastYawSpeed.getCurrentValue()) {
                this.currentYawSpeed = this.lastYawSpeed.getCurrentValue();
                this.isAccelerating = false;
            }
        } else {
            this.currentYawSpeed = this.firstYawSpeed.getCurrentValue();
    ...
    public void onClick(EventClick e) {
        ...
        if (mc.screen == null && mc.player != null && this.pos != null) {
            ...
            if (this.mode.isCurrentMode("Telly Bridge")) {
                canPlace = this.offGroundTicks >= getoffGroundTicks.getCurrentValue();
            } else if (this.mode.isCurrentMode("Heypixel Telly")) {
                canPlace = this.offGroundTicks >= getoffGroundTicks.getCurrentValue();
