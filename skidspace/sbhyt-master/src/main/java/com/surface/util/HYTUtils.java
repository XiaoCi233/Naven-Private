...
public class HYTUtils {
    ...
    public static boolean isHoldingKBBall(EntityPlayer player) {
        ItemStack holdingItem = player.getEquipmentInSlot(0);

        return isKBBall(holdingItem);
    }

    public static boolean isHoldingFireball(EntityPlayer player) {
        ItemStack holdingItem = player.getEquipmentInSlot(0);

        return isFireEnchantBall(holdingItem);
    }
    ...
    public static int isStrength(EntityPlayer player) {
        PotionEffect regenPotion = player.getActivePotionEffect(Potion.damageBoost);
