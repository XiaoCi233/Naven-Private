...
import com.surface.events.EventBlockRenderSide;
import com.surface.events.EventCollideWithBlock;
...
public class Block
{
    ...
    public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side)
    {
        ...
        final EventBlockRenderSide event = new EventBlockRenderSide(Minecraft.getMinecraft().theWorld.getBlockState(pos).getBlock(), pos, side);
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
        ...
        EventCollideWithBlock c = new EventCollideWithBlock(this, pos, axisalignedbb);
        Wrapper.Instance.getEventManager().call(c);
        axisalignedbb = c.getBoundingBox();
