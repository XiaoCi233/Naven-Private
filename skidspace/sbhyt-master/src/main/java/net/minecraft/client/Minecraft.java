...
import com.surface.events.EventPlace;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void runGameLoop() throws IOException
    {
        ...
        LinearAnimation.setDelta(deltaTime);
        Wrapper.delta = deltaTime;
    ...
    {
        return this.theWorld == null && this.currentScreen != null ? 8964 : this.gameSettings.limitFramerate;
    }
    ...
    {
        if (theWorld != null) {
            Wrapper.Instance.getEventManager().call(new EventTick());
            if (thePlayer != null) {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState() && currentScreen == null)
                    Wrapper.Instance.getEventManager().call(new EventKey(Keyboard.getEventKey() == 0 ? Keyboard.getEventCharacter() + 256 : Keyboard.getEventKey()));
            ...
            Wrapper.Instance.getEventManager().call(eventClick);
    ...
    {
        Wrapper.Instance.getEventManager().call(new EventWorldLoad());
