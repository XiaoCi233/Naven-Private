...
import com.surface.mod.world.DisablerModule;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        ...
        {
            Wrapper.Instance.getEventManager().call(new EventUpdate());
            super.onUpdate();
            if (isSprinting()) {
                ticksSprint++;
            } else {
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        final EventPreUpdate previous = new EventPreUpdate(this.posX, this.getEntityBoundingBox().minY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround, isSprinting(), isSneaking());
        Wrapper.Instance.getEventManager().call(previous);
        ...
        if (this.isCurrentViewEntity()) {
            final double x = previous.getX();
            final double y = previous.getY();
            final double z = previous.getZ();
            final float yaw = previous.getYaw();
            final float pitch = previous.getPitch();
            final boolean ground = previous.isOnGround();
            final double d0 = x - this.lastReportedPosX;
            final double d1 = y - this.lastReportedPosY;
            final double d2 = z - this.lastReportedPosZ;
            final double d3 = (yaw - this.lastReportedYaw);
            final double d4 = (pitch - this.lastReportedPitch);
            ...
            Wrapper.Instance.getEventManager().call(new EventPostUpdate());
        }
    }
    ...
    public void onLivingUpdate()
    {
        ...
        if ((this.isUsingItem() /*|| ((KillAuraModule)Wrapper.Instance.getModManager().getModFromName("Kill Aura")).blocking*/) && !this.isRiding())
        {
