...
import com.surface.util.render.shader.KawaseBloom;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        bloomFramebuffer = ShaderElement.createFrameBuffer(bloomFramebuffer);
        ...
        KawaseBloom.renderBlur(bloomFramebuffer.framebufferTexture, 3, 1);
        ShaderElement.getBloomTasks().clear();
        Wrapper.Instance.getEventManager().call(new Event2D(scaledresolution, partialTicks));
