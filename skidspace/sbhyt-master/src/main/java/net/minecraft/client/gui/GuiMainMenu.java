...
import com.surface.util.element.CustomButton;
...
import renderassist.animations.LayeringAnimation;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    {
        this.buttonList.add(new CustomButton(1, this.width / 2 - 100, p_73969_1_, "Single Player"));
        this.buttonList.add(new CustomButton(2, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1, "Multi Player"));
        this.buttonList.add(this.realmsButton = new CustomButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, "Options"));
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if (button.id == 5)
        {
            LayeringAnimation.play(new GuiLanguage(this, this.mc.gameSettings, this.mc.getLanguageManager()));
        }
    ...
    {
        if (Wrapper.Instance.bubbleShader == null) Wrapper.Instance.bubbleShader = new ShaderBubble();


        Wrapper.Instance.bubbleShader.renderShader(this.width, this.height);
...
//        }
        ...
        GlStateManager.popMatrix();
        String s = "Minecraft 1.8.9/Surface";
        ...
        FontManager.TAHOMA.drawString("Welcome, " + EnumChatFormatting.GREEN + Wrapper.Instance.getUsername(), 10, height - 35, new Color(255, 255, 255, 200).getRGB());
        FontManager.TAHOMA.drawString("Copyright Mojang AB. Do not distribute!", 10, height - 25, new Color(255, 255, 255, 200).getRGB());
        FontManager.TAHOMA.drawString("Minecraft 1.8.8 (" + Config.getVersion() + ")", 10, height - 15, new Color(255, 255, 255, 200).getRGB());

        String s2 = "This is a test version!";
