...
import com.surface.mod.visual.BlockAnimationsModule;
import com.surface.mod.visual.NoHurtCamModule;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void hurtCameraEffect(float partialTicks)
    {
        ...
        {
            NoHurtCamModule noHurtCam = (NoHurtCamModule) Wrapper.Instance.getModManager().getModFromName("NoHurtCam");
            if (noHurtCam.isEnable()) {
                return;
            }
    ...
    private void orientCamera(float partialTicks)
    {
        ...
        } else if (!this.mc.gameSettings.debugCamEnable)
        {
            ...
            else
            {
                ...
                if (scaffold.isEnable() && scaffold.lockview.getValue()) {
