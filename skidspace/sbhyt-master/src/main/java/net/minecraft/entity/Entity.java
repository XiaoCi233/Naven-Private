...
public abstract class Entity implements ICommandSender
{
    ...
    public com.surface.util.Vector3d getCustomPositionVector() {
        return new com.surface.util.Vector3d(posX, posY, posZ);
    }
    ...
    public float getDistanceToEntity2(Entity entityIn) {
        Vec3 eyes = this.getPositionEyes(1F);
