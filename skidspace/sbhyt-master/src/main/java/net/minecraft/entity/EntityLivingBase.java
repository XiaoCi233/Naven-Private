...
import com.surface.events.EventEntityUpdate;
import com.surface.events.EventJump;
...
public abstract class EntityLivingBase extends Entity
{
    ...
    public void onEntityUpdate()
    {
        ...
        Wrapper.Instance.getEventManager().call(new EventEntityUpdate(this));
    ...
    public void moveEntityWithHeading(float strafe, float forward)
    {
        ...
        {
            if (!(this.isInWater() && !NoSlowModule.shouldCancelWater) || this instanceof EntityPlayer && ((EntityPlayer)this).capabilities.isFlying)
            {
                if (!(this.isInLava() && !NoSlowModule.shouldCancelWater) || this instanceof EntityPlayer && ((EntityPlayer)this).capabilities.isFlying)
                {
                    float f4 = 0.91F;
    ...
    public void onLivingUpdate()
    {
        ...
        double motion = ViaLoadingBase.getInstance().getTargetVersion().getVersion() > 47 ? 0.003D : 0.005D;
        ...
        if (this.isJumping)
        {
            if (this.isInWater() && !NoSlowModule.shouldCancelWater)
            {
                this.updateAITick();
            }
            else if (this.isInLava() && !NoSlowModule.shouldCancelWater)
            {
                this.handleJumpLava();
            }
