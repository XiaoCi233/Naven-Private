...
import com.cubk.event.impl.EventCancelledException;
...
public class PacketThreadUtil
{
    ...
    public static <T extends INetHandler> void checkThreadAndEnqueue(final Packet<T> p_180031_0_, final T p_180031_1_, IThreadListener p_180031_2_) throws ThreadQuickExitException
    {
        ...
        {
            EventPacket packetReceive = new EventPacket(p_180031_0_,EventPacket.MODE_RECEIVE);
            if(Minecraft.getMinecraft().thePlayer != null) Wrapper.Instance.getEventManager().call(packetReceive);
