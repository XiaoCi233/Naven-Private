            ...
            for (int k1 = i; k1 < j; ++k1)
            {
                for (int l1 = k; l1 < l; ++l1)
                {
                    for (int i2 = i1; i2 < j1; ++i2)
                    {
                        ...
                        if(NoSlowModule.shouldCancelWater && (block == Blocks.water || block == Blocks.flowing_water)){
                            continue;
                        }
                        if(NoSlowModule.shouldCancelWater && (block == Blocks.lava || block == Blocks.flowing_lava)){
                            continue;
                        }
