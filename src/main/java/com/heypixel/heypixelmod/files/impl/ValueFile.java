...
import com.heypixel.heypixelmod.values.ValueType;
...
public class ValueFile extends ClientFile {
   ...
   public void read(BufferedReader reader) throws IOException {
      ...
      HasValueManager hasValueManager = com.heypixel.heypixelmod.BlinkFix.getInstance().getHasValueManager();
   ...
   public void save(BufferedWriter writer) throws IOException {
      ValueManager valueManager = com.heypixel.heypixelmod.BlinkFix.getInstance().getValueManager();
