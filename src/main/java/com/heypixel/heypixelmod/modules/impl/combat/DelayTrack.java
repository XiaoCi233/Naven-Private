...
//            .getFloatValue();
    ...
    private boolean isAuraEnabledOrBypassed() {
        if (!this.killAuraEnableCheck.getCurrentValue()) {
            ...
            try {
                return BlinkFix.getInstance().getModuleManager().getModule(Aura.class).isEnabled();
    ...
    private boolean isBot(Entity entity) {
        try {
            AntiBots antiBotsModule = (AntiBots) com.heypixel.heypixelmod.BlinkFix.getInstance().getModuleManager().getModule(AntiBots.class);
    ...
    private boolean isTeammate(Entity entity) {
        try {
            Teams teamsModule = (Teams) com.heypixel.heypixelmod.BlinkFix.getInstance().getModuleManager().getModule(Teams.class);
