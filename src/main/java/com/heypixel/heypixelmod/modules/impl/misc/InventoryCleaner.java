...
public class InventoryCleaner extends Module {
   ...
   public static int getMaxBlockSize() {
      return (int)((InventoryCleaner) com.heypixel.heypixelmod.BlinkFix.getInstance().getModuleManager().getModule(InventoryCleaner.class)).maxBlockSize.getCurrentValue();
   }

   public static boolean shouldKeepProjectile() {
      return ((InventoryCleaner) com.heypixel.heypixelmod.BlinkFix.getInstance().getModuleManager().getModule(InventoryCleaner.class)).keepProjectile.getCurrentValue();
   }

   public static int getMaxProjectileSize() {
      return (int)((InventoryCleaner) com.heypixel.heypixelmod.BlinkFix.getInstance().getModuleManager().getModule(InventoryCleaner.class)).maxProjectileSize.getCurrentValue();
   }

   public static int getMaxArrowSize() {
      return (int)((InventoryCleaner) com.heypixel.heypixelmod.BlinkFix.getInstance().getModuleManager().getModule(InventoryCleaner.class)).maxArrowSize.getCurrentValue();
   }

   public static int getWaterBucketCount() {
      return (int)((InventoryCleaner) com.heypixel.heypixelmod.BlinkFix.getInstance().getModuleManager().getModule(InventoryCleaner.class)).waterBucketCount.getCurrentValue();
   }
