...
public class SelfRescue extends Module implements PermissionGatedModule {
    ...
    public void onMotion(EventMotion event) {
        ...
        if (mc.player.getDeltaMovement().y < 0.1 &&
            ...
            Module stuck = com.heypixel.heypixelmod.BlinkFix.getInstance().getModuleManager().getModule(Stuck.class);
    ...
    public void onDisable() {
        ...
        if (scaffoldEnabled) {
            Module scaffold = com.heypixel.heypixelmod.BlinkFix.getInstance().getModuleManager().getModule(Scaffold.class);
            if (scaffold != null) {
                scaffold.setEnabled(false);
            }
            scaffoldEnabled = false;
