...
import com.heypixel.heypixelmod.utils.renderer.ez.EaseCube;
import com.heypixel.heypixelmod.utils.renderer.ez.EaseOutExpo;
...
public class Island extends Module {
    ...
    public void onRender2D(EventRender2D e) {
        ...
        try {
            scaffold = (Scaffold) BlinkFix.getInstance().getModuleManager().getModule(Scaffold.class);
