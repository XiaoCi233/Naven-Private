...
import com.heypixel.heypixelmod.modules.impl.misc.ContainerStealer;
...
public class ItemTags extends Module {
    ...
    private final float PHYSICS_HEIGHT_OFFSET = -0.25f;
    ...
    private void updatePositions(float renderPartialTicks) {
        ...
        boolean isPhysicsEnabled = BlinkFix.getInstance().getModuleManager()
                .getModule(ItemPhysics.class).isEnabled();
        ...
        for (Entity entity : mc.level.entitiesForRendering()) {
            if (entity instanceof ItemEntity) {
                ...
                if (this.isValidItem(itemEntity.getItem())) {
                    ...
                    double y = MathUtils.interpolate(renderPartialTicks, entity.yo, entity.getY())
                            + (double)entity.getBbHeight()
                            + (isPhysicsEnabled ? PHYSICS_HEIGHT_OFFSET : 0.5);
