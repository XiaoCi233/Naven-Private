package com.heypixel.heypixelmod.utils.rotation;

import com.heypixel.heypixelmod.BlinkFix;
import com.heypixel.heypixelmod.events.api.EventTarget;
import com.heypixel.heypixelmod.events.api.types.EventType;
import com.heypixel.heypixelmod.events.impl.EventAttackYaw;
...
import com.heypixel.heypixelmod.events.impl.EventPositionItem;
import com.heypixel.heypixelmod.events.impl.EventRayTrace;
...
import com.heypixel.heypixelmod.modules.impl.combat.AimAssist;
import com.heypixel.heypixelmod.modules.impl.combat.AttackCrystal;
import com.heypixel.heypixelmod.modules.impl.combat.Aura;
import com.heypixel.heypixelmod.modules.impl.move.AutoMLG;
...
public class RotationManager {
   ...
   public void updateGlobalYaw(EventRunTicks e) {
      if (e.getType() == EventType.PRE && mc.player != null) {
         ...
         AttackCrystal attackCrystal = (AttackCrystal) com.heypixel.heypixelmod.BlinkFix.getInstance().getModuleManager().getModule(AttackCrystal.class);
         AutoMLG autoMLG = (AutoMLG) com.heypixel.heypixelmod.BlinkFix.getInstance().getModuleManager().getModule(AutoMLG.class);
         AimAssist aimAssist = (AimAssist) com.heypixel.heypixelmod.BlinkFix.getInstance().getModuleManager().getModule(AimAssist.class);
         LongJump longJump = (LongJump) com.heypixel.heypixelmod.BlinkFix.getInstance().getModuleManager().getModule(LongJump.class);
         active = true;
   ...
   public void onPre(EventMotion e) {
      if (e.getType() == EventType.PRE) {
         ...
         Scaffold scaffold = (Scaffold) com.heypixel.heypixelmod.BlinkFix.getInstance().getModuleManager().getModule(Scaffold.class);
