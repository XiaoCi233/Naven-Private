...
public class InventoryCleaner extends Module {
    ...
    private final FloatValue delay = ValueBuilder.create(this, "Delay (ms)")
            ...
            .build()
            .getFloatValue();
    public ModeValue offhandItems = ValueBuilder.create(this, "Offhand Items")
   ...
   public static int getMaxBlockSize() {
      return (int)((InventoryCleaner) BlinkFix.getInstance().getModuleManager().getModule(InventoryCleaner.class)).maxBlockSize.getCurrentValue();
   }

   public static boolean shouldKeepProjectile() {
      return ((InventoryCleaner) BlinkFix.getInstance().getModuleManager().getModule(InventoryCleaner.class)).keepProjectile.getCurrentValue();
   }

   public static int getMaxProjectileSize() {
      return (int)((InventoryCleaner) BlinkFix.getInstance().getModuleManager().getModule(InventoryCleaner.class)).maxProjectileSize.getCurrentValue();
   }

   public static int getMaxArrowSize() {
      return (int)((InventoryCleaner) BlinkFix.getInstance().getModuleManager().getModule(InventoryCleaner.class)).maxArrowSize.getCurrentValue();
   }

   public static int getWaterBucketCount() {
      return (int)((InventoryCleaner) BlinkFix.getInstance().getModuleManager().getModule(InventoryCleaner.class)).waterBucketCount.getCurrentValue();
   }

   public static int getLavaBucketCount() {
      return (int)((InventoryCleaner) BlinkFix.getInstance().getModuleManager().getModule(InventoryCleaner.class)).lavaBucketCount.getCurrentValue();
   }
   ...
   public boolean isItemUseful(ItemStack stack) {
    ...
    public void onEnable() {
        ...
        // Check if delay is less than 100 when enabling InventoryCleaner
   ...
   public void onMotion(EventMotion e) {
      if (e.getType() == EventType.PRE) {
         ...
         if (ContainerStealer.isWorking()
            || BlinkFix.getInstance().getModuleManager().getModule(Scaffold.class).isEnabled()
