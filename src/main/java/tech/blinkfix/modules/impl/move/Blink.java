...
import tech.blinkfix.modules.impl.combat.AntiBots;
import tech.blinkfix.modules.impl.misc.Teams;
import tech.blinkfix.modules.impl.render.HUD;
import tech.blinkfix.modules.impl.render.projectiles.ProjectileData;
import tech.blinkfix.modules.impl.render.projectiles.datas.BasicProjectileData;
import tech.blinkfix.modules.impl.render.projectiles.datas.EntityArrowData;
import tech.blinkfix.utils.BlinkingPlayer;
import tech.blinkfix.utils.FriendManager;
import tech.blinkfix.utils.NetworkUtils;
import tech.blinkfix.utils.RayTraceUtils;
...
public class Blink extends Module {
   ...
   public void onShader(EventShader e) {
      ...
      if (e.getType() == EventType.SHADOW) {
         ...
         // 进度条填充 Shadow
         RenderUtils.drawRoundedRect(e.getStack(), (float)x, (float)y, this.progress.value, 5.0F, 2.0F, Integer.MIN_VALUE);
      }
   }
